...
export class InvalidFactorError extends ScaleError {
	...
	constructor(
		...
		super(
			detail ??
				`Invalid scale factor "${value}". Use a positive, finite number.`,
		);
	}
}
...
export class AlternativeTargetError extends ScaleError {
	...
	constructor(
		public readonly targetId: string,
		public readonly siblingIds: string[],
	) {
		super(
...
export class FixedIngredientError extends ScaleError {
	...
	constructor(
		public readonly targetId: string,
		public readonly reason: "protected" | "text",
	) {
		super(
			reason === "text"
