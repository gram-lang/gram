...
export const fr: GramLocale = {
	renderer: {
		...
		totalTimeTooltip: "Temps Total = Préparation + Actif + Attente",
		...
		ingredientsOverhead: "Ingrédients (base)",
		cookwareOverhead: "Matériel (base)",
		breakdownActive: "Actif",
		...
		mixedUnitsTooltip:
			"Impossible de fusionner en un seul total — ajoutez une densité à la base de données pour les convertir",
		...
		nutrients: {
			...
			mono_fat: "acides gras mono-insaturés",
			poly_fat: "acides gras polyinsaturés",
			carbs: "Glucides",
			sugar: "sucres",
			fiber: "Fibres",
			protein: "Protéines",
	...
	playground: {
		...
		views: {
			...
			gantt_active: "Tâche active",
			gantt_passive: "Tâche de fond",
			gantt_compact: "Vue compacte",
			gantt_time: "Temps",
			gantt_cook: "Actions",
			...
			gantt_mode_forward: "Chronomètre (T+)",
