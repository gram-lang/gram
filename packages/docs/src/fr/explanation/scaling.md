...
| `RELATIVE_TARGET` | La quantité est dérivée par formule (`70% @&farine`) | Mettez plutôt la cible à l'échelle (`farine`) — voir [Quantités Relatives](/fr/reference/syntax/relative-quantities) |
