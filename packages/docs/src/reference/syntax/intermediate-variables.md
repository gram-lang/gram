...
Intermediate `&variable` declarations **do not** appear in the generated shopping list. The Gram Compiler already knows that the `&puff pastry` is made of flour and butter, and it will count the raw flour and butter towards your shopping list instead.
:::
