...
description: "How @gram-lang/analyzer standardizes ingredient mass, resolves aliases, and estimates nutrition using a database."
---
...
<LinkCard  title="Shopping List Aggregation"
    description="See how shopping list aggregates for the full breakdown and fallback behavior."
    href="/docs/explanation/shopping-list-aggregation"
/>
