...
See [Module Imports](/docs/reference/syntax/modules) for the `@use` syntax itself, and `@gram-lang/modules` for resolving and composing an import graph into a single AST.
