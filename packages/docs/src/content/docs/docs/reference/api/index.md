...
See also: [Data Formats](/docs/reference/api/data-formats) for the shape of the JSON objects flowing between these stages, and [How to Build a Custom UI](/docs/how-to/build-custom-ui) for a walkthrough of consuming the final JSON in a frontend framework.
