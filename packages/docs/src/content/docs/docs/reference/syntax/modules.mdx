...
---
title: 'Eggs, Separated'
---

## Blancs ->&blancs
[Separate] @egg{100g} into whites only.

## Jaunes ->&jaunes
[Separate] @egg{50g} into yolks only.
```
...
`&blancs{200g}` against a measured 100g of blancs is a ×2 ratio; `&jaunes{50g}` against a measured 50g of jaunes is ×1. The larger ratio (×2) applies to the whole module, so jaunes comes out to 100g produced against the 50g actually used — Gram reports that surplus via `MODULE_SURPLUS` rather than silently discarding it.
