...
3. ### Enrichir les Données
   ...
   Faire cela manuellement est fastidieux. Gram peut faire appel à l'IA pour le faire à votre place par lots (voir [Configurer l'IA](/fr/docs/how-to/configure-ai)) :
