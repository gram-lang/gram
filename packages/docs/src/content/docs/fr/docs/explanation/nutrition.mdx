...
1. **Standardisation des Masses** : Avant qu'aucun calcul nutritionnel ne puisse avoir lieu, l'Analyseur doit d'abord convertir chaque ingrédient de la recette en une masse standard en grammes. (Voir [Standardisation des Masses](./mass-and-yield.mdx)).
