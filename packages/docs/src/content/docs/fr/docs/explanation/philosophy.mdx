...
<CardGrid>
  ...
  <Card title="Language Server (LSP)" icon="laptop">
    Apporte un vrai support éditeur à vos recettes (autocomplétion, diagnostics, infobulles).
  </Card>
...
<LinkCard
  ...
  description="Consultez le guide Pour Commencer pour installer Gram et écrire votre première recette."
