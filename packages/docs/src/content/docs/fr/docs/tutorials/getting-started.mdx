...
description: "Installez le CLI Gram, configurez votre éditeur et compilez votre première recette avec ce guide de démarrage."
---
...
2. **Configuration de l'éditeur**
   ...
   <details>
   <summary>Construire depuis les sources</summary>
...
5. **Compiler la Recette**
   ...
   Si vous ne voulez encore rien installer, vous pouvez tester Gram directement sur le web via le [Playground](/fr/play/) (ou ouvrir la recette à l'aide de l'[Extension VS Code](https://marketplace.visualstudio.com/items?itemName=gram-lang.gram-lang)).
   :::
...
Maintenant que vous avez vu les bases, il est temps de découvrir la véritable puissance des variables relationnelles, des minuteurs et de la mise à l'échelle automatique en écrivant une recette plus complexe :
<CardGrid>
