...
- **Timeline Generation (ALAP Scheduling)**: The engine uses an **As Late As Possible (ALAP)** scheduling algorithm through a four-phase compilation to generate a highly optimized execution timeline.
