		...
		if (issue.type === "plural") {
			...
			for (const aliasId of aliasIds) {
				...
				if (isMap(aliasNode)) {
					...
					const oldAliases: string[] = isSeq(aliasesRaw)
						? aliasesRaw.toJSON()
						: [];
