...
export default defineCommand({
  ...
  async run({ args }) {
    if (args.second && args.ref) {
      log.error('--ref is only valid when diffing against git history. Omit it when passing two explicit files.')
