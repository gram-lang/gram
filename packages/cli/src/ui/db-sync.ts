...
export function renderSyncResult(result: DbSyncResult, dryRun: boolean): void {
	const { newIngredients, aliasedIngredients, existingIngredients, dbPath } =
		result;
