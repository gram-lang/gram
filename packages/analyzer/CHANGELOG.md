...
- fbb7511: **Analyzer**: Fixed recipe total mass and section weights to include ingredients defined as relative percentages of another ingredient (e.g. `@water{60% @&flour}`).
